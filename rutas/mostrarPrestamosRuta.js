...
const { mostrarPrestamos } = require ('../controladores/mostrarPrestamosControlador.js');
...
router.get('/prestamosBiblioteca', verificarRol(['administrador', 'registrador', 'profesor', 'estudiante']), mostrarPrestamos);
//router.get('/prestamosBiblioteca', mostrarPrestamos);
