...
const { mostrarEstudiantes } = require ('../controladores/mostrarEstudiantesControlador.js');
...
router.get('/estudiantesBiblioteca', verificarRol(['administrador', 'registrador', 'profesor', 'estudiante']), mostrarEstudiantes);
//router.get('/estudiantesBiblioteca', mostrarEstudiantes);
