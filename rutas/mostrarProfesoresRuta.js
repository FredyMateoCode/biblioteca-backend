...
const { mostrarProfesores } = require ('../controladores/mostrarProfesoresControlador.js');
...
router.get('/profesoresBiblioteca', verificarRol(['administrador', 'registrador', 'profesor', 'estudiante']), mostrarProfesores);
