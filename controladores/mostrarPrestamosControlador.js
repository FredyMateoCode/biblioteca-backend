...
const {obtenerPrestamos} = require('../modelos/mostrarPrestamosModelo.js');
/*Definimos el controlador de express: En controladores/mostrarLibrosControlador.js
...
const mostrarPrestamos = (req, res) =>{
	obtenerPrestamos((err, resultados)=>{
		if(err){
			return res.status(500).json({error: 'Hubo un error al obtener los Prestamos'});
		}
