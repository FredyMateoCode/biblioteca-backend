...
const {obtenerLibros} = require('../modelos/mostrarLibrosModelo.js');
...
const mostrarLibros = (req, res) =>{
	obtenerLibros((err, resultados)=>{
		if(err){
			return res.status(500).json({error: 'Hubo un error al obtener los Libros'});
		}
