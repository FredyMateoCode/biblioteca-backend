...
const {obtenerRegistros} = require('../modelos/mostrarRegistrosModelo.js');
...
const mostrarRegistros = (req, res) =>{
	obtenerRegistros((err, resultados)=>{
		if(err){
